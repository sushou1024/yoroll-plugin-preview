...
Use `https://d1oj393jowuzw8.cloudfront.net/mcp` and `https://dev.yoroll.ai` only. Never rewrite
an MCP-returned URL to `app.yoroll.ai`, the production API, or another environment.
